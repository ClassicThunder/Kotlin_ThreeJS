...
native
fun Window.removeEventListener(name: String, vCode: (Event) -> Unit, idk: Boolean): Unit = js.noImpl

native
fun HTMLDocument.addEventListener(name: String, vCode: (Event) -> Unit, idk: Boolean): Unit = js.noImpl
native
fun HTMLDocument.removeEventListener(name: String, vCode: (Event) -> Unit, idk: Boolean): Unit = js.noImpl
